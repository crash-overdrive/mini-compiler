...
echo linker output.merl print.merl '|' java cs241.merl 0 '>' final.mips
linker output.merl print.merl | java cs241.merl 0 > final.mips

echo java mips.array final.mips
